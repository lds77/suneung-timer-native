...
export const MESSAGES = {
  ...
  ultraStart: [{ char: 'toru', text: '집중모드 시작! 같이 하자' },{ char: 'paengi', text: '집중모드! 이탈 0회 가보자!' },{ char: 'taco', text: '집중모드 ON! 이탈 없이 가보자!' },{ char: 'totoru', text: '조용히 집중하자. 할 수 있어.' }],
  ...
  ultraExit: [{ char: 'toru', text: '어디 가는 거야... 같이 하기로 했잖아' },{ char: 'paengi', text: '집중 모드인데! 다시 돌아와!' },{ char: 'taco', text: '잠깐! 공부 중이었잖아!' },{ char: 'totoru', text: '...돌아올 거지?' }],
  ...
  screenOff: [{ char: 'toru', text: '일반모드 시작! 화면 꺼도 괜찮아' },{ char: 'taco', text: '조용히 집중! 화면 끄고 열공!' }],
