...
const ACCENT_COLORS = {
  pink:   {
    ...
    h: ['#FFE0EC', '#FF8CB8', '#FF4D8A', '#D4356E'],   // 30m, 1h, 2h, 4h+
    dh: ['#4A2035', '#8B3060', '#CC4880', '#FF6B9D'],
  },
  purple: {
    accent: '#6C5CE7',
    bg: '#F6F4FE', t1: '#EDE8FF', t2: '#DDD0FA', t3: '#C0B0E8',
    dt1: '#1C1A30', dt2: '#28254A', dt3: '#352F5A',
    h: ['#E0DCFF', '#A898F0', '#7B68EE', '#5040C0'],
    dh: ['#302860', '#5040A0', '#6C5CE7', '#8B7FFF'],
  },
  blue:   {
    accent: '#4A90D9',
    bg: '#F3F8FD', t1: '#E0EEFA', t2: '#C8DEF5', t3: '#A0C4E8',
    dt1: '#141E30', dt2: '#1E2E48', dt3: '#283A58',
    h: ['#D0E4F8', '#80B8E8', '#4A90D9', '#2868B0'],
    dh: ['#1E3050', '#2E5090', '#4A90D9', '#6AAAF0'],
  },
  mint:   {
    accent: '#00B894',
    bg: '#F0FAF7', t1: '#DCF5ED', t2: '#B8EBD8', t3: '#90D8C0',
    dt1: '#142824', dt2: '#1E3830', dt3: '#28483C',
    h: ['#C8F5E8', '#60DDB8', '#00B894', '#008868'],
    dh: ['#1A3830', '#207858', '#00B894', '#40D8B0'],
  },
  navy:   {
    accent: '#2C5F9E',
    bg: '#F0F3F8', t1: '#DEE6F2', t2: '#C0D0E8', t3: '#98B4D8',
    dt1: '#101828', dt2: '#182238', dt3: '#1E2E4A',
    h: ['#C8D8F0', '#7898C8', '#2C5F9E', '#1A3D6E'],
    dh: ['#162840', '#284878', '#2C5F9E', '#5888C8'],
  },
  coral:  {
    accent: '#E07050',
    bg: '#FDF5F2', t1: '#FFEAE3', t2: '#FFD5C8', t3: '#F0B8A8',
    dt1: '#281815', dt2: '#3A2420', dt3: '#48302A',
    h: ['#FFD8CC', '#F0A088', '#E07050', '#B84830'],
    dh: ['#3A2420', '#885040', '#E07050', '#FF9878'],
  },
  slate:  {
    accent: '#64748B',
    bg: '#F8FAFC', t1: '#F1F5F9', t2: '#E2E8F0', t3: '#CBD5E1',
    dt1: '#0F172A', dt2: '#1E293B', dt3: '#334155',
    h: ['#E0E4EA', '#9CAAB8', '#64748B', '#3D4D60'],
    dh: ['#283040', '#404E60', '#64748B', '#8898A8'],
  },
};
