...
function GuideSection({ id, title, color, T, children, openId, onOpen, scrollRef }) {
  ...
  return (
    ...
    >
      ...
      {open && (
        <View style={{ paddingHorizontal: 14, paddingTop: 10, paddingBottom: 6, backgroundColor: T.surface2, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, borderLeftWidth: 3, borderLeftColor: color, marginTop: -2 }}>
