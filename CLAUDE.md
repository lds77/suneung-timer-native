...
- **현재 버전**: iOS 1.0.41 (buildNumber 58, **2026-08-25 심사 제출 — 대기 중**) / Android 1.0.40 (vc72).
  ...
  전부 OTA 3회로 이미 라이브). ★★그래서 **런타임이 다시 갈라진다** — iOS 1.0.41 / 안드 1.0.40.
  다음 OTA는 **런타임별로 두 번 쏴야 안드까지 닿는다**★★ (08-09~08-25 동안만 하나로 닿았다).
...
## 출시 현황 (2026-08-25 기준 — 라이브는 양 플랫폼 1.0.40, iOS 1.0.41 빌드/제출 진행 중)
